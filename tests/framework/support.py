...
SAMPLE_ACCEPTANCE_NODE_CHROMIUM = f"{SAMPLE_ACCEPTANCE_TEST_NAME}[chromium]"
...
SAMPLE_GENERATED_PROJECT = "WDR5"
SAMPLE_DEMO_RES1_FILE_NAME = "res1-XXX-ZZ-ZZ-CA-D-1234.txt"
SAMPLE_KEEP_MANUAL_FILE_NAME = "test-XXX-ZZ-XX-AF-A-12345.txt"
...
MSG_ITEM_NOT_IN_LIST = "{name} must not be in the item list"
MSG_BANNER_MUST_CONTAIN = "error banner must contain {hint}, got {actual}"
MSG_BANNER_MUST_BE_HIDDEN = "error banner must be hidden after a valid Project"
